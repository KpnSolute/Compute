-- Atomic upsert function for monthly_inventory received fields.
-- Replaces the read-modify-write pattern in apply_invoice to eliminate
-- lost-update race conditions when two managers submit invoices concurrently.
--
-- Apply via: Supabase Dashboard > SQL Editor, or via MCP apply_migration.
