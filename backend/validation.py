...
INVENTORY_ITEM_UPDATE_SCHEMA = {
    'field': {'type': 'str', 'required': True, 'enum': ['onHand', 'w1i', 'w2i', 'w3i', 'w4i', 'w1r', 'w2r', 'w3r', 'w4r', 'price', 'par', 'on_hand', 'w1_issued', 'w2_issued', 'w3_issued', 'w4_issued', 'w1_received', 'w2_received', 'w3_received', 'w4_received', 'unit_price', 'par_level']},
    'value': {'required': True},
